...
- Added high-performance numerical solvers (C++, Boost, GNU Scientific Library) to the [MOOSE simulator](https://github.com/dilawar/moose)
...
- Published Python packages: [PlotDigitizer](https://pypi.org/project/plotdigitizer) (extract raw data from plot images), [SerialScope](https://github.com/dilawar/SerialScope) (serial-port oscilloscope)
